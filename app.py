...
def page_1():
  ...
  ###Instruction###
  Never answer like a mechanical Chat bot, Behave like a human and strictly follow the <Bot Description>.
...
"""}
  ...
  if prompt := st.chat_input():
    ...
    response = openai.chat.completions.create(model='gpt-4-0613', messages=st.session_state.messages, temperature=1.3, top_p=0.95, max_tokens=48)
